...
import { createPasswordReset, getCurrentUser, getRefreshCookieOptions, login, registerCustomer, resetPassword, revokeRefreshToken, rotateRefreshToken, } from "./auth.service.js";
...
authRouter.post("/forgot-password", async (req, res, next) => {
    try {
        const result = await createPasswordReset(forgotPasswordSchema.parse(req.body));
        sendSuccess(res, {
...
function getOptionalRefreshTokenCookie(cookies) {
