...
export async function revokeRefreshToken(refreshToken) {
    ...
    await AuthSessionModel.updateOne({ tokenHash: hashToken(refreshToken), revokedAt: { $exists: false } }, { $set: { revokedAt: new Date() } });
}
export async function getCurrentUser(principal) {
